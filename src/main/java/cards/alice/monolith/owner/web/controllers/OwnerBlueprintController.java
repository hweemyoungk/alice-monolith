...
public class OwnerBlueprintController {
    ...
    @Value("${cards.alice.owner.web.controllers.path.base}/${cards.alice.owner.web.controllers.path.card}")
    ...
    public ResponseEntity<Set<BlueprintDto>> listBlueprints(@RequestParam Long storeId, @RequestParam List<Long> ids) {
        ...
        final Set<BlueprintDto> blueprintDtos = ownerBlueprintService.listBlueprints(storeId, new HashSet<>(ids));
